package net.crazysnailboy.mods.betterfarmers.entity.passive;

import java.util.Random;
import javax.annotation.Nullable;
import net.crazysnailboy.mods.betterfarmers.hooks.VillagerHooks;
...
public class EntityVillager extends net.minecraft.entity.passive.EntityVillager
{
...
//            }
//			else if (VillagerHooks.isFarmer(getProfessionForge()))
//			{
//				this.tasks.addTask(6, new net.crazysnailboy.mods.betterfarmers.entity.ai.EntityAIHarvestFarmland(this, 0.6D));
//			}
//        }
    }
...
//        if (VillagerHooks.isFarmer(getProfessionForge())) //if (this.getProfession() == 0)
//        {
...
//        boolean flag = VillagerHooks.isFarmer(getProfessionForge());
//        return !this.hasEnoughItems(flag ? 5 : 1);
